...
:SINCE: Wed Jun 21 16:54:11 2017
:VERSION: 0.1
...
__date__ = 'Wed Jun 21 16:54:11 2017'
__version__ = '0.1'
__file_name__='crc16.py'
__description__='Compute the CRC16'
#===============================================================================
# IMPORT STATEMENTS
#===============================================================================
import struct
...
# METHODS
#===============================================================================
global CRC_TABLE_CCITT16
CRC_TABLE_CCITT16 = ['0000', '1021', '2042', '3063', '4084', '50a5', '60c6', '70e7',
...
for i in range(0,len(CRC_TABLE_CCITT16)):
    CRC_TABLE_CCITT16[i]=int(CRC_TABLE_CCITT16[i],16)
                     
# receives a vector of bytes e.g. ['AA','AA']
def crc(data):
    global CRC_TABLE_CCITT16
    '''
    ...
    for b in range(0,len(data)):
        crc = CRC_TABLE_CCITT16[((crc ^ data[b]) & 0x00FF)] ^ (crc >> 8)              
